...
public interface InstancioObjectApi<T> extends
    ...
    /**
     * Sets the strategy for populating objects.
     * Refer to the {@link PopulationStrategy} javadoc for details.
     *
     * @param populationStrategy the strategy to use for field population
     ...
     */
    @ExperimentalApi
    InstancioObjectApi<T> withPopulationStrategy(PopulationStrategy populationStrategy);
