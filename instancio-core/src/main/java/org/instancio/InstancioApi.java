...
public interface InstancioApi<T> extends
    ...
    @Override
    @ExperimentalApi
    <V extends @Nullable Object> InstancioApi<T> setModel(TargetSelector selector, Model<V> model);
    ...
    @Override
    @ExperimentalApi
    <V extends @Nullable Object> InstancioApi<T> filter(TargetSelector selector, FilterPredicate<V> predicate);
