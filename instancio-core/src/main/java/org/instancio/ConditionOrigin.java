...
/**
 * Represents a condition that must be specified by the origin selector.
 *
 * @since 3.0.0
 */
@ExperimentalApi
public interface ConditionOrigin {
     ...
     * @since 3.0.0
     */
    <T> RequiredConditionalAction satisfies(Predicate<T> predicate);
     ...
     * @since 3.0.0
     */
    <T> RequiredConditionalAction is(T value);
    ...
    <T> RequiredConditionalAction isIn(T... values);
}
