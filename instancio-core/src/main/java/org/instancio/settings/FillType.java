 ...
 * {@link InstancioObjectApi#fill()}. Each type determines which fields
 * should be considered for population based on their current values.
 *
 * <p>Fill types follow a hierarchical pattern where each subsequent type
...
public enum FillType {
     ...
     * default values. This combines the behavior of {@link #POPULATE_NULLS}
