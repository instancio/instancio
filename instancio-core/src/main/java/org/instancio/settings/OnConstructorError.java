...
public enum OnConstructorError {
    ...
    /**
     * Create the object without invoking any constructor and populate it
     * via fields or setters. No other constructor is attempted.
     *
     * <p>This requires {@link InstantiationStrategy#BYPASS_CONSTRUCTOR} to be
     * present in {@link Keys#INSTANTIATION_STRATEGIES}. Otherwise, or if the
     * JVM does not permit the allocation, the object will be {@code null}.
     *
     * @since 6.0.0
     */
    BYPASS_CONSTRUCTOR,
