...
public final class Keys {
     ...
     * default is {@link OnConstructorError#BYPASS_CONSTRUCTOR}; property name {@code on.constructor.error}.
     *
    ...
    public static final SettingKey<OnConstructorError> ON_CONSTRUCTOR_ERROR = registerRequiredNonAdjustable(
            "on.constructor.error", OnConstructorError.class, OnConstructorError.BYPASS_CONSTRUCTOR);
