...
/**
 * An action to be performed if a {@link Conditional} is satisfied.
 * The methods provided by this interface match the top-level API
 * methods {@code set()}, {@code supply()}, and {@code generate()}.
 *
 * @see Conditional
 * @see ConditionalAction
 * @see RequiredConditionalAction
 * @since 3.0.0
 */
@ExperimentalApi
public interface Action {
     ...
     * @since 3.0.0
     */
    <T> ConditionalAction generate(TargetSelector selector, GeneratorSpecProvider<T> gen);
     ...
     * @since 3.0.0
     */
    <T> ConditionalAction generate(TargetSelector selector, GeneratorSpec<T> spec);
     ...
     * @since 3.0.0
     */
    <T> ConditionalAction set(TargetSelector selector, T value);
     ...
     * @since 3.0.0
     */
    <T> ConditionalAction supply(TargetSelector selector, Generator<T> generator);
     ...
     * @since 3.0.0
     */
    <T> ConditionalAction supply(TargetSelector selector, Supplier<T> supplier);
}
