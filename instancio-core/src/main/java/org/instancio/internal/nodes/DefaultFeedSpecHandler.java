...
final class DefaultFeedSpecHandler implements FeedSpecHandler {

    private static final FeedSpecHandler NOOP_HANDLER = node -> {
    };
    ...
    static FeedSpecHandler create(final NodeContext nodeContext) {
