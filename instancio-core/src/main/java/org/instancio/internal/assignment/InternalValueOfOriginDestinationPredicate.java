...
public class InternalValueOfOriginDestinationPredicate
        implements ValueOfOriginDestinationPredicate, Assignment, Flattener<InternalAssignment> {
    ...
    public InternalValueOfOriginDestinationPredicate(
            ...
            final @Nullable Predicate<?> predicate,
            final @Nullable RandomFunction<?, ?> valueMapper) {
