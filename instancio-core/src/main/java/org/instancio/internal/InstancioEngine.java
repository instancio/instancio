...
class InstancioEngine {
    ...
    private Object invokeConstructor(
        ...
        try {
            ...
            // error (for records) or silently swallowed by the constructor bypass.
            ...
            Log.msg(Log.Category.CONSTRUCTOR_BYPASSED,
                    "Error instantiating {} via constructor (configurable via '{}'). "
                            + "Bypassing the constructor and creating the object without it.",
