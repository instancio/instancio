...
final class FillObjectHelper {
    ...
    static List<Type> getTypeArgs(final Object object) {
        ...
        final Type[] nonNullTypeArgs = ApiValidator.doesNotContainNull(typeArgs, () ->
        ...
        return CollectionUtils.asUnmodifiableList(nonNullTypeArgs);
    }
    ...
    @Nullable
    private static Class<?> getType(@Nullable final Object o) {
