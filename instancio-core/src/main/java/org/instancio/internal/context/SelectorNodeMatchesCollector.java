...
final class SelectorNodeMatchesCollector {
    ...
    private final SelectorMap<?> withFeedSelectorMap;
    ...
    SelectorNodeMatchesCollector(final SelectorMaps selectorMaps) {
        ...
        this.withFeedSelectorMap = selectorMaps.getFeedSelectorMap().getSelectorMap();
    }
    ...
    public Map<ApiMethodSelector, Map<TargetSelector, Set<InternalNode>>> getNodeMatches(final InternalNode rootNode) {
        ...
        while (!queue.isEmpty()) {
            ...
            collectNodes(map, ApiMethodSelector.WITH_FEED, node, withFeedSelectorMap);
    ...
    public Map<ApiMethodSelector, Set<TargetSelector>> getUnusedSelectors() {
        ...
        map.put(ApiMethodSelector.WITH_FEED, collectSelectors(withFeedSelectorMap));
        return map;
    }
