...
final class ModelContextSource {
    ...
    private final Map<TargetSelector, Schema> schemaMap;
    ...
    ModelContextSource(
            ...
            final Map<TargetSelector, Schema> schemaMap,
        ...
        this.schemaMap = asUnmodifiableMap(schemaMap);
    ...
    Map<TargetSelector, Schema> getSchemaMap() {
        return schemaMap;
    }
