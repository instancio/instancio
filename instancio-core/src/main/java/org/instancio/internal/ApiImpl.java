...
public class ApiImpl<T> implements InstancioApi<T>, InstancioObjectApi<T> {
    ...
    public ApiImpl(final T object) {
        ...
        this.modelContextBuilder.withPopulateObject(object);
    }
    ...
    @Override
    public ApiImpl<T> withPopulationStrategy(final PopulationStrategy populationStrategy) {
        this.modelContextBuilder.withPopulationStrategy(populationStrategy);
        return this;
    }
