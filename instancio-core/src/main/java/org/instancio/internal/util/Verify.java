...
public final class Verify {
    ...
    public static <T> T notNull(final @Nullable T object, final String message, final Object... values) {
        return Objects.requireNonNull(object, () -> String.format(message, values));
    }

    public static <T> void notEmpty(final T @Nullable[] array, final String message, final Object... values) {
        isTrue(array != null && array.length > 0, message, values);
    }

    public static <T> void notEmpty(final @Nullable Collection<T> collection, final String message, final Object... values) {
