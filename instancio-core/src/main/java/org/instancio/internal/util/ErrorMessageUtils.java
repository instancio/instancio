...
public final class ErrorMessageUtils {
    ...
    public static String feedComponentMethodNotFound(
        ...
        return new StringBuilder(INITIAL_SB_SIZE)
                .append("invalid method name 'badName' specified by the `@FunctionSpec.params` attribute in feed class:").append(NL)
                .append(NL)
    ...
    public static String feedWithoutDataSource(final Class<?> feedClass) {
        return new StringBuilder(INITIAL_SB_SIZE)
                ...
                .append(NL)
                .append(" -> Via the @FeedSource annotation:").append(NL)
                .append(NL)
                .append("    @FeedSource(path = \"path/to/data/sample.csv\")").append(NL)
    ...
    public static String feedDataEnd(
        ...
        final String dataEndKey = keyDesc(Keys.FEED_DATA_END_STRATEGY);
        final String currentDataAccess = enumValueDesc(settings.get(Keys.FEED_DATA_ACCESS));
        final String curentDataEndStrategy = enumValueDesc(settings.get(Keys.FEED_DATA_END_STRATEGY));
        ...
        return new StringBuilder(INITIAL_SB_SIZE)
                ...
                .append(enumValueDesc(FeedDataEndStrategy.RECYCLE)).append(NL)
