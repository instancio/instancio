...
final class JavaxPersistenceHandlerMap extends CommonPersistenceAnnotationHandlerMap {
    ...
    JavaxPersistenceHandlerMap() {
        put(() -> javax.persistence.Column.class, new ColumnHandler());
    }
    ...
    private static final class ColumnHandler extends AbstractColumnHandler {
        ...
        int getLength(final Annotation annotation) {
            return ((javax.persistence.Column) annotation).length();
        }

        @Override
        int getPrecision(final Annotation annotation) {
            return ((javax.persistence.Column) annotation).precision();
        }

        @Override
        int getScale(final Annotation annotation) {
            return ((javax.persistence.Column) annotation).scale();
        }
    }

    private static final class Holder {
        private static final AnnotationHandlerMap INSTANCE = new JavaxPersistenceHandlerMap();
    }
}
