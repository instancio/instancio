...
public final class ApiValidator {
    ...
    public static void validateConditionalOriginSelector(final TargetSelector selector) {
        ...
        ApiValidator.isFalse(selector instanceof SelectorGroup,
                "invalid origin selector%n%n" +
                        "Conditional origin must not match more than one target." +
        ...
        if (selector instanceof PrimitiveAndWrapperSelectorImpl) {
            ...
            throw Fail.withUsageError(
                    "conditional origin must not be a primitive/wrapper selector such as %s%n%n" +
