...
public final class Instantiator {
    ...
    private static List<InstanceCreator> buildCreators(
        ...
        return instantiationStrategies.contains(InstantiationStrategy.BYPASS_CONSTRUCTOR)
                ? List.of(UnsafeInstanceCreator.getInstance(), ReflectionFactoryInstanceCreator.getInstance())
                : List.of();
    }
