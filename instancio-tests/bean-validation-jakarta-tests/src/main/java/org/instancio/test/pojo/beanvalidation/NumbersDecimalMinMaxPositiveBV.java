...
@Data
public class NumbersDecimalMinMaxPositiveBV implements Numbers {
    public static final String MIN_STR = "10.5";
    public static final String MAX_STR = "19.5";
    ...
    public static final BigDecimal MAX_ROUNDED = MAX.setScale(0, RoundingMode.HALF_UP);
