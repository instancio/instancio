...
import org.instancio.test.pojo.beanvalidation.NumbersMinMaxPositiveBV;
...
class NumbersMinMaxPositiveBVTest {
    ...
    void minMax() {
        ...
        Asserts.assertRange(result, NumbersMinMaxPositiveBV.MIN, NumbersMinMaxPositiveBV.MAX);
    }
}
