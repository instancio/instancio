...
@FeatureTag({Feature.BEAN_VALIDATION, Feature.WITH_FEED})
@ExtendWith(InstancioExtension.class)
class WithFeedBVTest {
    ...
    @Test
    void withFeedShouldTakePrecedenceOverBeanValidationAnnotations() {
