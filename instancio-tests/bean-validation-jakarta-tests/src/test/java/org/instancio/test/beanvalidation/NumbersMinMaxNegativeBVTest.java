...
import org.instancio.test.pojo.beanvalidation.NumbersMinMaxNegativeBV;
...
class NumbersMinMaxNegativeBVTest {
    ...
    void minMax() {
        ...
        Asserts.assertRange(result, NumbersMinMaxNegativeBV.MIN, NumbersMinMaxNegativeBV.MAX);
    }
}
