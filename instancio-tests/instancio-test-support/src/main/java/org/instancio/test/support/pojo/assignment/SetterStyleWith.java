...
public class SetterStyleWith implements SetterStylePojo {
    ...
    public void withIntegerWrapper(final Integer integerWrapper) {
        this.integerWrapper = integerWrapper;
        viaSetter_integerWrapper = true;
    }

    public void withString(final String string) {
        this.string = string;
        viaSetter_string = true;
    }

    public void withBooleanProperty(final boolean booleanProperty) {
        isBooleanProperty = booleanProperty;
        viaSetter_isBooleanProperty = true;
    }

    public void withBooleanWrapper(final Boolean booleanWrapper) {
        isBooleanWrapper = booleanWrapper;
        viaSetter_isBooleanWrapper = true;
    }

    public void withNoIsPrefixBooleanProperty(final boolean noIsPrefixBooleanProperty) {
        this.noIsPrefixBooleanProperty = noIsPrefixBooleanProperty;
        viaSetter_noIsPrefixBooleanProperty = true;
    }

    public void withNoIsPrefixBooleanPropertyWrapper(final Boolean noIsPrefixBooleanPropertyWrapper) {
