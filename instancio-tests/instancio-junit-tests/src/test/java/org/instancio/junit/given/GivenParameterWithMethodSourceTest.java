...
class GivenParameterWithMethodSourceTest {
    ...
    private static final List<Pojo> results = new ArrayList<>();
    ...
    void methodSourceWithGeneratedParams(
            ...
            @Given final String givenString) {

        assertThat(givenString).isNotBlank();

        // Since this method is run more than once, collect the results
        // from multiple invocations and verify in another method
        results.add(new Pojo(methodSourceNumber, methodSourceString, givenString));
    }
