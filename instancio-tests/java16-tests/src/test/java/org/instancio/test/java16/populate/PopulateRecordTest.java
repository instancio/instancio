 ...
 */
package org.instancio.test.java16.populate;
...
class PopulateRecordTest {

    @Test
    @DisplayName("populate() should not throw an exception if given a record instance")
    void populateShouldNotThrowingAnExceptionIfGivenARecord() {
    ...
    @Test
    @DisplayName("populate() should not throw an exception if given a nested record instance")
    void populateShouldNotThrowingAnExceptionIfGivenANestedRecord() {
