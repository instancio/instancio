...
public class CyclicArrayCreationTest extends CreationTestTemplate<CyclicArray> {

    @Override
    protected void verify(CyclicArray result) {
        CyclicArray[] items = result.getItems();
