...
@GenericsTag
public class MapWithTypeVariablesIntegerStringCreationTest
        extends CreationTestTemplate<MapWithTypeVariables<Integer, String>> {

    @Override
    protected void verify(MapWithTypeVariables<Integer, String> result) {
