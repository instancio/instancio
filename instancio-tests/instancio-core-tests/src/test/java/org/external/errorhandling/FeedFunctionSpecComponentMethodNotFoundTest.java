    ...
    String expectedMessage() {
        return """
                ...
                Error creating an object
                 -> at org.external.errorhandling.FeedFunctionSpecComponentMethodNotFoundTest.methodUnderTest(FeedFunctionSpecComponentMethodNotFoundTest.java:42)

                Reason: invalid method name 'badName' specified by the `@FunctionSpec.params` attribute in feed class:
