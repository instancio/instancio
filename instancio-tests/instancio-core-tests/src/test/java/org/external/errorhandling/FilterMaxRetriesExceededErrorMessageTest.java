...
class FilterMaxRetriesExceededErrorMessageTest extends AbstractErrorMessageTestTemplate {
    ...
    String expectedMessage() {
        return """
                ...
                Reason: all generated values were rejected by the filter() predicate: class String (depth=0)
                ...
                To resolve this error, please update the predicate to ensure a value is accepted.
