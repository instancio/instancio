...
@FeatureTag({Feature.SCHEMA, Feature.VALUE_SPEC, Feature.SETTINGS})
@ExtendWith(InstancioExtension.class)
class SchemaWithSettingsTest {
    ...
    void shouldUseTagFromAnnotatedSettings1() {
        final SampleSchema schema = Instancio.ofSchema(SampleSchema.class)
                .withSettings(Settings.create().set(Keys.SCHEMA_TAG_VALUE, "RU"))
                .create();
    ...
    void shouldUseTagFromAnnotatedSettings2() {
        ...
        final String result = Instancio.of(String.class)
                .generate(allStrings(), schema.field1())
                .create();
