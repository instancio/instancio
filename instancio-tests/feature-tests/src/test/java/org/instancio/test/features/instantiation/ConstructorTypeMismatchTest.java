 ...
 * <p>
 * See: https://github.com/instancio/instancio/issues/1795
 */
...
class ConstructorTypeMismatchTest {
     ...
     * bypassing the constructor and instantiating the object without it.
     */
    @Test
    void constructorParameterOfClassWithBypassEnabled() {
        final InstancioApi<StringsAbcCtor> api = Instancio.of(StringsAbcCtor.class)
                .withSetting(Keys.ON_CONSTRUCTOR_ERROR, OnConstructorError.BYPASS_CONSTRUCTOR)
                .set(field(StringsAbcCtor::getA), Gender.FEMALE);
