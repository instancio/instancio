 ...
 */
package org.instancio.test.features.generator.id.usa;
...
class SsnGeneratorTest {
    ...
    @Test
    void ssn() {
        final String result = create(gen -> gen.id().usa().ssn());
    ...
    @Test
    void nullable() {
        final Stream<String> result = Stream.generate(() -> create(gen -> gen.id().usa().ssn().nullable()))
