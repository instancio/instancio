...
class ConditionalWithSelectorGroupTest {
    ...
    private static Stream<Arguments> args() {
        ...
        final TargetSelector destination = Select.all(
        ...
        return Stream.of(
                Arguments.of(When.valueOf(origin).satisfies(predicate).set(destination, EXPECTED)),
                Arguments.of(When.given(origin, destination).set(predicate, EXPECTED))
        );
    }
    ...
    void destinationGroup(final Conditional conditional) {
