...
class WithSchemaSelectorTest {
    ...
    //@formatter:off
    // Note: 'value' field maps to the corresponding schema property,
    ...
    @ParameterizedTest
    void applySchemaToOuter(final TargetSelector selector) {
    ...
    @ParameterizedTest
    void applySchemaToMid(final TargetSelector selector) {
        final Schema schema = Instancio.createSchema(SampleSchema.class);
    ...
    @ParameterizedTest
    void applySchemaToInner(final TargetSelector selector) {
        final Schema schema = Instancio.createSchema(SampleSchema.class);
    ...
    @ParameterizedTest
    void applySchemaToAll(final TargetSelector selector) {
        final Schema schema = Instancio.createSchema(SampleSchema.class);
