...
@FeatureTag({Feature.CONDITIONAL, Feature.OF_MAP})
@ExtendWith(InstancioExtension.class)
class ConditionalWithOfMapTest {
    ...
    void valueConditional() {
        final Map<UUID, StringsGhi> results = Instancio.ofMap(UUID.class, StringsGhi.class)
                ...
                .when(valueOf(StringsGhi::getG).is("G2").set(field(StringsGhi::getI), "I2"))
                .create();
    ...
    void keyValueConditional() {
        final Map<Integer, StringsGhi> results = Instancio.ofMap(Integer.class, StringsGhi.class)
                .when(valueOf(Integer.class).satisfies((Integer i) -> i % 2 == 0).set(allStrings(), "even"))
                .when(valueOf(Integer.class).satisfies((Integer i) -> i % 2 != 0).set(allStrings(), "odd"))
                .create();
