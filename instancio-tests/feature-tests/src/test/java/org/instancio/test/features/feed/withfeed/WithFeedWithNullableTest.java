...
@FeatureTag({Feature.FEED, Feature.WITH_FEED, Feature.WITH_NULLABLE})
@ExtendWith(InstancioExtension.class)
class WithFeedWithNullableTest {

    @WithSettings
    private static final Settings settings = Settings.create()
            .set(Keys.FEED_DATA_END_STRATEGY, FeedDataEndStrategy.RECYCLE);

    @Feed.Source(data = "value\nfoo\nbar\nbaz")
    ...
    void withNullable() {
        ...
        final List<StringHolder> result = Instancio.ofList(StringHolder.class)
                ...
                .withFeed(all(StringHolder.class), feed)
