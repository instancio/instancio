...
class TituloEleitoralSpecTest extends AbstractValueSpecTestTemplate<String> {

    @Override
    protected TituloEleitoralSpec spec() {
        return Instancio.gen().id().bra().tituloEleitoral();
    }
