...
@FeatureTag({Feature.CONDITIONAL, Feature.UNSUPPORTED})
@ExtendWith(InstancioExtension.class)
class ConditionalUnsupportedTest {
    ...
    void whenPhoneThenCountry() {
        ...
        final Address result = Instancio.of(Address.class)
                ...
                .when(valueOf(Phone::getCountryCode).is("+1").set(field(Address::getCountry), canada))
