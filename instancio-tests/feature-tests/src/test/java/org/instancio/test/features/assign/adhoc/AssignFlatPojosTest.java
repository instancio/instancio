...
class AssignFlatPojosTest {
    ...
    void whenC_thenA_whenA_thenE_whenE_thenB() {
        final Root result = Instancio.of(Root.class)
                ...
                .assign(Assign.given(C::getVal).is(C_VAL).set(field(A::getVal), A_VAL))
                .assign(Assign.given(A::getVal).is(A_VAL).set(field(E::getVal), E_VAL))
                .assign(Assign.given(E::getVal).is(E_VAL).set(field(B::getVal), B_VAL))
                .create();
    ...
    void whenE_thenD_whenD_thenC_whenC_thenB_whenB_thenA() {
        final Root result = Instancio.of(Root.class)
                ...
                .assign(Assign.given(E::getVal).is(E_VAL).set(field(D::getVal), D_VAL))
                .assign(Assign.given(D::getVal).is(D_VAL).set(field(C::getVal), C_VAL))
                .assign(Assign.given(C::getVal).is(C_VAL).set(field(B::getVal), B_VAL))
                .assign(Assign.given(B::getVal).is(B_VAL).set(field(A::getVal), A_VAL))
                .create();
