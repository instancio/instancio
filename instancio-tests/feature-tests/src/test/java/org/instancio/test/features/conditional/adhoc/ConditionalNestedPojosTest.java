...
class ConditionalNestedPojosTest {
    ...
    void whenH_thenC_whenC_thenF_whenF_thenD() {
        final Root result = Instancio.of(Root.class)
                ...
                .when(valueOf(H::getVal).is(H_VAL).set(field(C::getVal), C_VAL))
                .when(valueOf(C::getVal).is(C_VAL).set(field(F::getVal), F_VAL))
                .when(valueOf(F::getVal).is(F_VAL).set(field(D::getVal), D_VAL))
                .create();
    ...
    void whenH_thenABCD() {
        final Root result = Instancio.of(Root.class)
                ...
                .when(valueOf(H::getVal).is(H_VAL)
    ...
    void whenF_thenBH() {
        final Root result = Instancio.of(Root.class)
                .set(field(F::getVal), F_VAL)
                .when(valueOf(F::getVal).is(F_VAL)
                        .set(field(B::getVal), B_VAL)
                        .set(field(H::getVal), H_VAL))
                .create();
    ...
    void whenH_thenF_whenF_thenD_whenD_thenA() {
        final Root result = Instancio.of(Root.class)
                .set(field(H::getVal), H_VAL)
                .when(valueOf(H::getVal).is(H_VAL).set(field(F::getVal), F_VAL))
                .when(valueOf(F::getVal).is(F_VAL).set(field(D::getVal), D_VAL))
                .when(valueOf(D::getVal).is(D_VAL).set(field(A::getVal), A_VAL))
                .create();
