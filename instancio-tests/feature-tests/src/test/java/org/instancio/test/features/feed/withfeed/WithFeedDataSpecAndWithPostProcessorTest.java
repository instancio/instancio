 ...
 */
package org.instancio.test.features.feed.withfeed;
...
@FeatureTag({Feature.FEED, Feature.WITH_FEED})
@ExtendWith(InstancioExtension.class)
class WithFeedDataSpecAndWithPostProcessorTest {

    @SuppressWarnings("unused")
    @Feed.Source(data = "countryCode,_number_\nc1,n1\nc2,n2\nc3,n3\n")
    ...
    void shouldPopulateObjectsUsingDeclaredFeedSpecMethods() {
        final Feed feed = Instancio.ofFeed(PhoneFeed.class)
                .withSetting(Keys.FEED_DATA_END_STRATEGY, FeedDataEndStrategy.RECYCLE)
                .create();
