 ...
 * affect the behaviour of the {@code populate()} method.
 */
@FeatureTag({Feature.AFTER_GENERATE, Feature.POPULATE})
@ExtendWith(InstancioExtension.class)
class PopulateAfterGenerateTest {

    @EnumSource(value = AfterGenerate.class)
    @ParameterizedTest
    void afterGenerateShouldHaveNoEffectOnPopulate(final AfterGenerate afterGenerate) {
