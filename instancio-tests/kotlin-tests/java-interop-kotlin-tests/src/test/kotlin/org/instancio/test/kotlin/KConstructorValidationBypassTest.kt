 ...
 *
 * With the default `ON_CONSTRUCTOR_ERROR=BYPASS_CONSTRUCTOR`, a constructor that rejects
...
class KConstructorValidationBypassTest {
    ...
    inner class InitBlockValidation {
        ...
        @Test
        fun bypassSilentlyIgnoresInitValidation() {
            // 'value' is a random Int, almost always outside 0..150.
            // With BYPASS_CONSTRUCTOR (default) the failing constructor is bypassed and the
    ...
    inner class NullSafety {
        ...
        @Test
        fun bypassAllowsNullInNonNullProperty() {
