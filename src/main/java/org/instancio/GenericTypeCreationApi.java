...
public class GenericTypeCreationApi<T> implements CreationApi<T> {
    ...
    @Override
    public <V> GenericTypeCreationApi<T> with(String field, ValueGenerator<V> generator) {
        modelContextBuilder.withFieldGenerator(getField(this.rootClass, field), generator);
        return this;
    }

    @Override
    public <V> GenericTypeCreationApi<T> with(Class<?> klass, String field, ValueGenerator<V> generator) {
        modelContextBuilder.withFieldGenerator(getField(klass, field), generator);
        return this;
    }

    @Override
    public <V> GenericTypeCreationApi<T> with(Class<V> klass, ValueGenerator<V> generator) {
