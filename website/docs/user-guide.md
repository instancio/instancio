...
!!! warning
    If you are using Hibernate 7 as your persistence provider,
    you may need to ignore fields with names starting with `$$_`.
    For more details, see this [issue](https://github.com/instancio/instancio/issues/1401).
...
ignore.field.name.prefixes=foo,bar
